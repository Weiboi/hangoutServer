...
public class WishDropServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("WishDropServlet--start");
        //常驻
        ...
        wishService.dropWish(teamId,userId,type,content);

        System.out.println("WishDropServlet--end");
    }
